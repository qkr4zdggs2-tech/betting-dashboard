...
function edgeColor(edge: number): string {
  ...
  if (edge >= 5)  return "text-emerald-400 bg-emerald-400/10";
...
export default function BetCard({
  ...
  return (
    <div
      onClick={onClick}
      className="bg-gray-900 border border-gray-800 rounded-xl p-5 flex flex-col gap-4 hover:border-emerald-600/50 hover:bg-gray-800/60 transition cursor-pointer group"
    >
      {/* Top row */}
      ...
      <div className="bg-gray-800 rounded-lg px-4 py-3 flex items-center justify-between">
        ...
        <div className="text-right">
          <p className="text-2xl font-bold text-emerald-400">{bet.bookOdds}</p>
